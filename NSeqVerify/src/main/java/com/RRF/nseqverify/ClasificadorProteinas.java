...
/**
 * Clase dedicada para la clasificación de secuencias de PROTEÍNAS usando BLASTp.
 * Extrae todas las métricas de la tabla de resultados del NCBI.
 * @author Roberto Reinosa Fernández
 */

public class ClasificadorProteinas {
    ...
    public void clasificarSecuencias(String archivoFastaEntrada, String archivoResultados) {
        ...
        try{
            ...
            System.out.println("Iniciando proceso de clasificación de proteínas (modo BLASTp)...");
            ...
            Logger.getLogger(ClasificadorProteinas.class.getName()).log(Level.SEVERE, null, e);
    ...
    /**
     * Envía una petición BLASTp al servidor del NCBI.
     */
    ...
    private String enviarBlastRequest(String secuencia) {
        ...
        try{
            ...
            String params = "CMD=Put&PROGRAM=blastp&DATABASE=nr&QUERY=" + URLEncoder.encode(secuencia, StandardCharsets.UTF_8.name());
